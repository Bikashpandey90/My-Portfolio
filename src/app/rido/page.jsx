      ...
      <div className="page sample-space">
        <section className="sample-space-hero">
          <div className="sample-space-hero-img">
            <img src="/spaces/rido2.png" alt="Arcade Residence Lisbon" />
          </div>
              ...
              <div className="sample-space-content-wrapper sample-space-meta">
                <div className="sample-space-hero-row">
                  ...
                  <div className="sample-space-hero-sub-col">
                    <Copy delay={0.1}>
                      <p>Tech Utilized</p>
                      <p>Bcrypt, JWT, GeoJson</p>
                      <p>Multer, Cloudinary</p>
                      <p>Leaflet</p>
                    </Copy>
                  </div>
                </div>
              ...
              <div className="sample-space-content-wrapper sample-space-meta">
                <div className="sample-space-hero-row">
                  <div className="sample-space-hero-sub-col">
                    <Copy delay={0.2}>
                      <p>Core Features</p>
                      <p>Driver-User matching</p>
                      <p>Navigations, Fare Calculation</p>
                      <p>Reviews, Coupons</p>
                    </Copy>
                  </div>
                  <div className="sample-space-hero-sub-col">
